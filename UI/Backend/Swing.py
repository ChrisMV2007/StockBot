    ...
    while active:
        ...
        if action == 'swing analysis':
            ...
            if SoW == 'stock':
                ...
                len = inp('How many intervals back would you like to measure swing for (see github readme for more '
                ...
                ema_len = inp('What would you like your averaging length to be (see github readme for more info)? ',
                              int_only=True, rep_msg='Please enter an integer.')
                step = inp('What would you like the step to be for your swing analysis (check github readme for more '
                ...
                posneg, certainty = Swing.swing_certainty(SP.get_hist(ticker, int(len) + int(ema_len), time_id),
                                                          ema_len, int(len),step)
                print(f'SWING RESULTS: {ticker} has a {posneg} trend (certainty : {certainty}%)')
